...
class RuntimeComparisonPlot:
    ...
    def __init__(self, timeout = 1800, fontsize = 12, plot_kwargs = {}, legend_kwargs = {}) -> None:
    ...
    def _extract_systems_dataframes(self, df: pd.DataFrame, system1: str, system2: str) -> Tuple[pd.DataFrame, str, str]:
    ...
    def plot(self, df: pd.DataFrame, system1: str, system2: str) -> None:
        ...
        points_above = 0
        merged_df, rt_label_1, rt_label_2 = self._extract_systems_dataframes(df, system1, system2)
        ...
        self._show_plot(ax, legend, system1, system2)
    
    def _show_plot(self, ax: plt.Axes, legend: list, system1: str, system2: str) -> None:
